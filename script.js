...
document.getElementById('display_menu').addEventListener('click', openMenu);
document.getElementById('menu_close').addEventListener('click', closeNav);
...
const workSections = document.querySelector('.works-section');
...
for (let i = 0; i < projectsList.length; i += 1) {
  document.querySelector(`.project-modal-${i}`).addEventListener('click', () => {
    ...
    document.querySelector('.works-section').classList.add('blur');
    document.querySelector('.header').classList.add('blur');
    document.getElementById('details').classList.add('blur');
    document.querySelector('.abt').classList.add('blur');
    document.querySelector('.contact-part').classList.add('blur');
...
const contactForm = document.querySelector('.contact-part');
